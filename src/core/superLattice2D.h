...
public:
  ...
  /// Defines the sponge dynamics on 2D near boundary domain
  void defineTwoDSpongeDynamics(T lx, T ly, T L, int buffersize, T omega, T rho_target, T u_target[2], Spongedynamics<T,DESCRIPTOR>* spongedynamics);
